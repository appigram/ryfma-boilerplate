...
const checkPostUploadPermissions = (metaContext) => {
  const userId = metaContext.userId
...
const postImageDirectiveSettings = {
  ...
  authorize: function (file, metaContext) {
    return checkPostUploadPermissions(metaContext)
  },
  key: function (file, metaContext) {
    ...
    return 'images/' + userId + '/posts/' + filenamePrefix + metaContext.time + '_' + filename + '.jpg'
  }
}
