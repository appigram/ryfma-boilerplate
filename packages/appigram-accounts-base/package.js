...
Package.onUse(api => {
  ...
  api.use('appigram:service-configuration', ['server'], { unordered: true });
  ...
  // the appigram:accounts-base package, modules that import appigram:accounts-base will
  ...
  // appigram:accounts-base package, and define exports that will be accessible to
  // modules that import the appigram:accounts-base package.
